...
ax.plot(x3, eta3_slice, '-', label='FD-2 (N = 201)')
ax.plot(x4, eta4_slice, '-', label='FD-2 (N = 401)')
ax.plot(x5, eta5_slice, '-', label='FD-2 (N = 801)')
ax.plot(x2, eta2_slice, '-', label='FD-2 (N = 1601)')
ax.set_xlim(72, 92)
ax.set_ylim(-0.6, 1.0)
