...
x_cheb_mapped, _ = construct_chebyshev_nodes(N_cheb, domain=tuple(domain))
...
gs = fig.add_gridspec(1, 3)  # two rows, first taller
...
ax2.set_title('(b)', loc='left', x=-0.15, fontsize=12, fontweight='bold')
...
ax3.text(1910, 2*1e-10, '$(b): N = 1900$',color='gray',fontsize=12)
