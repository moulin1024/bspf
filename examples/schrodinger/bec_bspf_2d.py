...
tau_ramp = 0.0             # 在前 tau_ramp 内线性 ramp 到 Omega_target
dt_imag = 0.0005           # initial imaginary-time 步长
tau_max = 1              # maximum imaginary-time to evolve
...
# Fixed-step RK23-like loop (no adaptivity, uses dt_imag throughout)
with tqdm(total=tau_max, desc="Imaginary-time", unit="tau", 
    ...
    while tau < tau_max - 1e-15:
        ...
        # Bogacki–Shampine stages (kept for consistency, but dt fixed)
