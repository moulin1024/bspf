...
from .boundary_conditions import enforce_zero_flux_neumann_bc, enforce_zero_flux_neumann_bc_2d
...
__all__ = [
    ...
    "enforce_zero_flux_neumann_bc", "enforce_zero_flux_neumann_bc_2d",
    "SchrodingerAnimator1D", "create_comparison_plot_config"
]

# Add optional imports
if PiecewiseBSPF1D is not None:
    __all__.append("PiecewiseBSPF1D")
if _has_gpu:
    __all__.append("bspf1d_gpu")
