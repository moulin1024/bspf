...
from .derivative import DerivativeComputer, DerivativeMethod, compute_derivative, compare_methods, compute_derivative_on_chebyshev_nodes
...
__all__ = [
    ...
    'compute_derivative',
    'compare_methods',
    'compute_derivative_on_chebyshev_nodes'
]
