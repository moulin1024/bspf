...
class TimeStepperState:
    ...
    Tracks previous states needed for multi-step methods like BDF2.
    ...
    def __init__(self, psi_init, t_init=0.0, dt=None, method='rk4', 
        ...
        method : str
            Time stepping method: 'rk4', 'rk45', 'rk23', or 'bdf2'
        ...
        # For BDF2: need 1 previous state
        self.psi_prev = None
...
def time_step(state: TimeStepperState, dt: float, rhs_func: Callable, 
    ...
    **kwargs : additional keyword arguments
    ...
    if method == 'rk4':
        ...
        raise ValueError(f"Unknown method: {method}. Use 'rk4', 'rk45', 'rk23', or 'bdf2'.")
...
def create_time_stepper(psi_init, method='rk4'):
    ...
    psi_init : array
        Initial solution state
    method : str
        Time stepping method: 'rk4' or 'bdf2'
